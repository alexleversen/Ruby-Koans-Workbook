...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Does the operation inside the block to each element
    # in the list, then sets the result to the current value.
    # Returns when it has gone over the whole list. Value
    # inside the parentheses is the starting value.
  end
